"""Temporary-table metadata and MCP proxy boundaries."""
...
from onec_runtime_mcp.agent.observation import (
    ManagerOrigin, ObservationItem, ObservationPlan, ObservationSource,
    ObservationSourceKind, SelectionKind, ValueSelection,
)
...
KERNEL_MODULE = (
    WORKSPACE / "onec" / "OnecInteractiveRuntime" / "CommonModules"
