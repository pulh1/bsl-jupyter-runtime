...
Скачайте **Source code (zip)** и `bsl-notebook-0.1.5.vsix` из [релиза v0.1.23](https://github.com/pulh1/bsl-jupyter-runtime/releases/tag/v0.1.23). В архиве исходников находятся `notebooks/demo`, а VSIX отвечает за подсказки BSL в редакторе. Python-пакеты версии 0.1.23 устанавливаются из PyPI.
...
& $python -m pip install "onec-interactive-jupyter==0.1.23" "ipykernel>=6.29,<7" "matplotlib>=3.11,<4"
...
[Открыть статью о проекте](https://infostart.ru/1c/tools/2789187/).
